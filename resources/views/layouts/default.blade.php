...
<head>
    ...
    {{-- En Blade, les {{}} permettent de faire un echo + htmlspecialchars qui protège des failles XSS
    Il est donc impératif d'utiliser ces doubles accolades pour insérer du PHP et renforcer la sécurité --}}
    <title>{{ $title }}</title>
    {{-- Feuille de style permettant de récupérer la police Inter / Sans import ça ne marche pas --}}
    <link rel="stylesheet" href="https://rsms.me/inter/inter.css">
    {{-- Directive vite faisant les liens vers les fichiers CSS et JS --}}
...
<body class="antialiased pt-10 pb-16 md:pb-32">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <header class="flex justify-between items-center space-x-5 text-slate-900">
            {{-- Logo --}}
            {{-- La fonction route permet de générer les différentes URLs --}}
            <a href="{{ route('index') }}">
